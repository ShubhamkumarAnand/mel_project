...
func (pg *PostgresWorkoutStore) CreateWorkout(workout *Workout) (*Workout, error) {
	...
	for _, entery := range workout.Entries {
		query := `
		...
		err = tx.QueryRow(query, workout.ID, entery.ExerciseName, entery.Sets, entery.Reps, entery.DurationSeconds, entery.Weight, entery.Notes, entery.OrderIndex).Scan(&entery.ID)
		if err != nil {
			return nil, err
		}
	}
